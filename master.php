...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <img alt="HMS" class="pull-left" src="<?php echo $base_url.'site/images/ss.png'?>" height="50px" width="50px"><a class="navbar-brand titlehms" href="<?php echo $base_url.'dashboard.php'?>"><b>Smart Hostel Management System</b></a>
        </div>
        <!-- /.navbar-header -->
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <a href="#"><i class="fa fa-list-alt fa-fw"></i>Apply Leaves<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            
                        
                            <li>
                                <a href="<?php echo $base_url.'ui/setup/room.php'?>">Leaves</a>
                            </li>
