...
<?php include('./master.php'); ?>
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header titlehms"><i class="fa fa-hand-o-right"></i>Dashboard</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                ...
                <div class="panel panel-red">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 text-right">
                                <div class="huge"></div>
                                <div class="addStyle">Hostel Layout</div>
                            </div>
                        </div>
                    </div>
                    <a href="./ui/meal/view.html">
                        <div class="panel-footer">
